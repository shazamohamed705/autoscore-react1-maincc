...
const handleArticleClick = (articleId) => {
 ...
 return (
   <>
     {/* من نحن  */}
     <section>
       <div className="about w-10/12 mx-auto my-5 py-5 ">
    ...
    <span className="text-red-600">سيرفيس</span>
         ...
         <div className="content mt-10 px-6">
           <p className='text-sm md:text-base leading-relaxed font-normal'>
             كار سيرفيس هو الفحص الأول في مصر و الشرق الأوسط الذي يعتمد على أسس علمية وهندسية في قياس كفاءة السيارة الداخلية والخارجية عن طريق فحص أكثر من 200 نقطة تشمل جميع أجزاء السيارة من النمرة للنمرة بنظام العلامة المئوية (السكور) بأحدث وسائل الفحص من شركة بوش الألمانية. يفحص نظام كار سيرفيس جميع مكونات السيارة من الشاصي والهيكل، الأنظمة الميكانيكية والكهربائية جميعها، من النمرة للنمرة لجميع أنواع السيارات (البنزين، الهايبرد والكهربائية).
             <br /><br />
             لدينا في كار سيرفيس شراكات محلية وعالمية للحصول على معلومات وتاريخ السيارة، بالإضافة الى الربط مع إدارة الترخيص للحصول على جميع المعلومات داخل مصر وارفاقها في تقرير كار سيرفيس.
             <br /><br />
             قطاع السيارات يتطور بشكل سريع، ودخول التكنولوجيا الحديثة في مجال صناعة السيارات يسبب عبء على المشتري لاتخاذ قرار شراء سيارة مستعملة، وجود كار سيرفيس يساعد المشتري على اتخاذ هذا القرار وحماية استثماره.
           </p>
         </div>
       </div>
     </section>
